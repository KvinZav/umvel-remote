...
export const ClientsTitle = ({ children }: HeadingProps) => (
  <h1
    className="leading-tight font-bold text-3xl md:text-5xl lg:text-6xl xl:h-auto">
    {children}
  </h1>
)
...
export const ClientsSubTitle = ({ children }: HeadingProps) => (
  <h2
    className="leading-tight font-normal text-2xl md:text-4xl lg:text-4xl xl:h-auto">
    {children}
  </h2>
)
