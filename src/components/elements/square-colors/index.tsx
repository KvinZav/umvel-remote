...
const SquareColors:React.FC<SquareColorsProps> = ({text,textSize='md'}):JSX.Element => {
    return (
        <div className="relative group w-full aspect-square grid grid-cols-4 grid-rows-5 lg:grid-rows-4 lg:grid-cols-4 lg:hover:grid-cols-4 justify-items-center place-items-center text-primary-black gap-1 lg:gap-0 cursor-pointer">
            ...
            <div className="w-full -translate-y-1 lg:translate-y-0 lg:group-hover:-translate-y-2 lg:group-hover:scale-50 scale-50 lg:scale-100 transition-all delay-150 ease-out duration-1000 aspect-square bg-prisma-lime" />
            <div className="w-full -translate-y-1 lg:translate-y-0 lg:group-hover:-translate-y-2 lg:group-hover:scale-50 scale-50 lg:scale-100 transition-all delay-150 ease-out duration-1000 aspect-square bg-prisma-yellow" />
            ...
            <div className="w-full -translate-y-1 lg:translate-y-0 lg:group-hover:-translate-y-2 lg:group-hover:scale-50 scale-50 lg:scale-100 transition-all delay-150 ease-out duration-1000 aspect-square bg-prisma-orange" />
