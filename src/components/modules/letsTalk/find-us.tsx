    ...
    <section>
      <div className="aspect-square xl:p-20 lg:p-10 bg-primary-black text-primary-white lg:flex hidden flex-col justify-between">
        <div>
          ...
          <h1 className="text-s1 md:text-m5 lg:text-m3 mt-2 xl:mt-4 font-bold">
            Feel free to reach out directly, either in person, per phone or email.
          </h1>
          <div className="flex mt-10 justify-between">
            <div className="w-5/12 mr-8">
              <p className="text-s3">Pay us a visit</p>
              <p className="text-s1 font-bold mt-2">
            ...
            <div className="w-5/12">
              <p className="text-s3">Call us</p>
              <p className="text-s1 font-bold mt-2">(+52) 55 6819 7071</p>
              <p className="text-s3 mt-12">Email us</p>
              <p className="text-s1 font-bold mt-2">hello@umvel.com</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-primary-black md:grid grid-cols-3 text-primary-white lg:hidden hidden">
        ...
        <div className="aspect-square border-solid border-[#333] border p-8">
          <p className="text-s3">Email us</p>
          <p className="text-s1 mt-2 font-bold">hello@umvel.com</p>
          <p className="text-s3 mt-8">Call us</p>
