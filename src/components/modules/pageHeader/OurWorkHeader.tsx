...
export const OurWorkHeader = ({data}: {data: Body}) => {
  return (
    <section className="w-full flex flex-col-reverse md:flex-row px-[72px] md:px-24 lg:px-60 py-20 md:py-[124px] lg:py-40">
        <div className="flex justify-center md:justify-end lg:ml-10 my-6">
          <PrismButton>
