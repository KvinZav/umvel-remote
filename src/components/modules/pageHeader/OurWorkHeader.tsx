...
export const OurWorkHeader = ({ data, onScrollButtonClick }: { data: Body, onScrollButtonClick: () => any }) => {
  return (
    <section className="w-full flex flex-col-reverse md:flex-row px-[72px] md:px-24 lg:px-60 py-24 md:py-[124px] lg:py-40 xl:py-[211px]">
      ...
      <div className="flex flex-col justify-evenly md:ml-16 xl:ml-[92px] text-center md:text-left my-2 space-y-2">
        <h1 className="lg:leading-tight text-[1.625rem] md:text-4xl lg:text-[58px] font-bold">
          {data.left.title}
        </h1>
