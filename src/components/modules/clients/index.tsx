...
export const Clients = () => {    
    ...
    return (
        <div className="grid place-content-center py-[104px] sm:py-[219px] lg:py-80 px-[72px] sm:px-36">
            <div className="grid gap-y-4 mb-20">
                <ClientsTitle>{title}</ClientsTitle>
                <ClientsSubTitle>{subtitle}</ClientsSubTitle>
            </div>
            <div className="grid grid-cols-2 gap-10 gap-y-8 sm:gap-x-6 lg:grid-cols-3 lg:gap-x-60 lg:gap-y-10">
